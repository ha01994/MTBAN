...
if True:
    ...
    new_weights = np.load('/home/ha01994/mutationTCN/_job%s/weights.npy'%jobId)    
    ...
    temp = 4
    save_out = np.load('/home/ha01994/mutationTCN/_job%s/save_out_teacher.npy'%jobId) #[num_train_data, seq_len, 24]
    ...
    with tf.Session(graph=graph) as sess:
        ...
        for step in range(training_steps):
            ...
            if step == training_steps - 1:
                ...
                os.system("mkdir /home/ha01994/databases/alignments_hp_updated_BAN/%s"%dd)
                with open('/home/ha01994/databases/alignments_hp_updated_BAN/%s/predictions_%s.csv'%(dd, dd), 'w') as f:
